    ...
    <div className="space-y-6">
      ...
      <Card title="🛠️ 调试与诊断">
        <div className="space-y-4">
          <div className="flex items-center justify-between">
            <div>
              <h4 className="text-sm font-medium text-slate-900 dark:text-white">显示系统终端</h4>
              <p className="text-xs text-slate-500 dark:text-slate-400">在侧边栏显示 C++/Python 服务实时日志页面</p>
            </div>
            <label className="relative inline-flex items-center cursor-pointer">
              <input 
                type="checkbox" 
                checked={settings.showTerminal} 
                onChange={(e) => handleSettingChange('showTerminal', e.target.checked)}
