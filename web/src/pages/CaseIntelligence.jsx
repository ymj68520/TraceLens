...
const CaseIntelligence = () => {
    ...
    // Tab 切换：'intelligence' 情报研判报告 | 'forensic' 取证快照报告
    const [reportTab, setReportTab] = useState('intelligence');
    ...
    return (
        <div className="max-w-[1600px] mx-auto space-y-6">
            {/* 报告视图切换 Tab */}
            <div className="flex gap-2 p-1.5 bg-slate-100 dark:bg-slate-800/50 rounded-xl">
                <button
