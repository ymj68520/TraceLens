...
export default function EventAnalysisPanel({ taskId, event, onRefresh, onTraceClaim, onTraceEvidence }) {
  ...
  return (
    <div className="p-5 space-y-5 overflow-y-auto h-full">
      ...
      <section><h3 className="text-sm font-semibold mb-2">证据构成</h3><div className="grid grid-cols-1 gap-2 text-center text-xs"><div className="rounded-xl bg-slate-100 dark:bg-slate-800 p-2"><div className="text-lg font-semibold">{event.evidence_count || 0}</div>关联 Evidence</div></div><p className="mt-2 text-[11px] text-slate-400">v7 调查事件不区分 primary/supporting 角色，证据角色以各 Evidence 的分析绑定为准。</p></section>
