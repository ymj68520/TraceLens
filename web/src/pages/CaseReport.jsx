...
// Subcomponent (split for maintainability)
import CaseReportTaskSelector from '../components/case-report/CaseReportTaskSelector';
...
const CaseReport = () => {
    ...
    const TaskSelector = () => (
        <CaseReportTaskSelector completedTasks={completedTasks} onSelect={handleTaskSelect} />
    );
