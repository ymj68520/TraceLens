...
class GraphitiCoreMixin:
    ...
    def _build_graphiti_config(self, group_id: str):
        ...
        # mvp-phase1-acceptance SPEC §3: the ingestion model is pinned to
        # phi-4 (settings default); never fall through to llm_text_model.
        llm_model = (getattr(self.settings, "graphiti_llm_model", "") or "").strip() or PINNED_GRAPHITI_MODEL
