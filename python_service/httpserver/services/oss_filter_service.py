...
from .oss_filter_parts import OSSFilterLegacyHelpersMixin


class OSSFilterService(OSSFilterLegacyHelpersMixin):
    """Filters OSS objects by case relevance using LLM.

    NOTE: legacy filter path + helpers live in OSSFilterLegacyHelpersMixin
    (oss_filter_parts/_legacy_helpers.py). Public surface unchanged.
    """
