...
public:
    ...
    // installed-app persistence and archive-member attribution.
    bool hasUniqueManifestBakFile(size_t index) const {
        return index < uniqueManifestBakFiles_.size() && uniqueManifestBakFiles_[index];
    }
