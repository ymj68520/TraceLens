...
void LinuxFilesAnalyzer::analyzeWithLLM() {
    ...
    try {
        ...
        // pipeline is out of the acceptance scope; linux_* structured data and
        // display are unaffected. (The enhanced log types were never wired into
        // this orchestration, so the trim changes nothing for them.)
